...
[ -d "${ROCM_ROOT_DIR}/ROCT-Thunk-Interface/" ] || git clone --single-branch --recursive -b roc-2.9.x https://github.com/RadeonOpenCompute/ROCT-Thunk-Interface.git ${ROCM_ROOT_DIR}/ROCT-Thunk-Interface
