...
export LD_LIBRARY_PATH=${ROCM_ROOT_DIR}/umd_lib/lib/; cmake -DUSE_PROF_API=1 -DCMAKE_BUILD_TYPE=Debug -DHCC_HOME=${ROCM_ROOT_DIR}/hcc/build/ -DHSA_PATH=${ROCM_ROOT_DIR}/umd_lib/hsa -DCMAKE_INSTALL_PREFIX=${ROCM_ROOT_DIR}/umd_lib ..
# -DHIP_COMPILER=clang
make -j install
